...
#define PIN_DC    5
#define PIN_CS    10
#define SPI_PORT  SPI   // Which SPIClass object to use - Teensy may support up to SPI3 (SPI, SPI1, SPI2, SPI3)
//#define PIN_SCK   13  Currently alternate pin assignments not supported when using custom SPI ports
//#define PIN_MOSI  11
...
void setup()
{
  oled.begin(&SPI_PORT);  // Initialize the OLED, providing a pointer to the SPIClass object you want to use
